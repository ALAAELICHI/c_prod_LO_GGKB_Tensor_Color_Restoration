function b=dwt_alaa(a,varargin)
...
if nargin == 0
  error(message('signal:dwt:Nargchk'));
end

% checks if X is a valid numeric data input
signal.internal.sigcheckfloattype(a,'','dwt','X');
...
n = signal.internal.sigcasttofloat(n,'double','dwt','N','allownumeric');
m = size(a,2);
